...
public class FoodUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(FoodUpdateActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
        ...
        if (bundle != null){
            Glide.with(FoodUpdateActivity.this).load(bundle.getString("Image")).into(updateImage);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Food Product").child(key);
    ...
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(FoodUpdateActivity.this);
    ...
    public void updateData(){
        ...
        if(imageUrl.isEmpty()) {
            Toast.makeText(FoodUpdateActivity.this, "Product Image is required", Toast.LENGTH_SHORT).show();
        }
        else if(productName.isEmpty()) {
            Toast.makeText(FoodUpdateActivity.this, "Product Name is required", Toast.LENGTH_SHORT).show();
            updateProductName.setError("Product Name is required");
            updateProductName.requestFocus();
        }
        else if(productDescription.isEmpty()) {
            Toast.makeText(FoodUpdateActivity.this, "Product Description is required", Toast.LENGTH_SHORT).show();
            updateProductDescription.setError("Product Description is required");
            updateProductDescription.requestFocus();
        }
        else if(productPrice.isEmpty()) {
            Toast.makeText(FoodUpdateActivity.this, "Product Price is required", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(FoodUpdateActivity.this, "Product Price is type Double", Toast.LENGTH_SHORT).show();
            ...
            databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        foodDAO.updateFoodByImageUrl(FoodProduct, oldImageURL);
                        reference.delete();
                        Toast.makeText(FoodUpdateActivity.this, "Updated", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(FoodUpdateActivity.this, FoodActivity.class);
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(FoodUpdateActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
