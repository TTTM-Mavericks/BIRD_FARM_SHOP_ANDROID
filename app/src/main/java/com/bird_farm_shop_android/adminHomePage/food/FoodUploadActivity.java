...
import com.bird_farm_shop_android.adminHomePage.bird.ProductDTO;
...
public class FoodUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_product_admin_homepage);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(FoodUploadActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(FoodUploadActivity.this);
    ...
    public void uploadData(){
        ...
        if(imageURL.isEmpty()) {
            Toast.makeText(FoodUploadActivity.this, "Product Image is required", Toast.LENGTH_SHORT).show();
        }
        else if(productName.isEmpty()) {
            Toast.makeText(FoodUploadActivity.this, "Product Name is required", Toast.LENGTH_SHORT).show();
            uploadProductName.setError("Product Name is required");
            uploadProductName.requestFocus();
        }
        else if(productDescription.isEmpty()) {
            Toast.makeText(FoodUploadActivity.this, "Product Description is required", Toast.LENGTH_SHORT).show();
            uploadProductDescription.setError("Product Description is required");
            uploadProductDescription.requestFocus();
        }
        else if(productPrice.isEmpty()) {
            Toast.makeText(FoodUploadActivity.this, "Product Price is required", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(FoodUploadActivity.this, "Product Price is type Double", Toast.LENGTH_SHORT).show();
            ...
            FirebaseDatabase.getInstance().getReference("Food Product").child(currentDate)
                    .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                foodDAO.createFood(FoodProduct);
                                Toast.makeText(FoodUploadActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(FoodUploadActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
