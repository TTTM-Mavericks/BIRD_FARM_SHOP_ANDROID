...
public class FoodActivityCustomer extends AppCompatActivity {
    ...
    private void NavigationBar(){
        ...
        homeCustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(FoodActivityCustomer.this, MainActivity.class);
            }
        });
        idBirdPage_Customer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(FoodActivityCustomer.this, BirdActivityCustomer.class);
            }
        });
        ...
        idFoodPage_Customer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(FoodActivityCustomer.this, FoodActivityCustomer.class);
            }
        });
        idNestPage_Customer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(FoodActivityCustomer.this, NestActivityCustomer.class);
            }
        });
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(FoodActivityCustomer.this, "Logout", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(FoodActivityCustomer.this, 1);
        BirdRecyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(FoodActivityCustomer.this);
        ...
        adapter = new MyAdapterCustomer(FoodActivityCustomer.this, dataList);
